...
insert into administracion.citasMedicas(codCita,codPaciente,codMedico,fechaHora) values
(upper(@cod),@codP,@codM,@fechaH)
...
create procedure medico.CrearReceta
(
	@codRe char(7),
	@fecha date
)
...
insert into medico.recetas(codReceta,codReporte,fechaEmitida) values
(upper(@cod),@codRe,@fecha)
